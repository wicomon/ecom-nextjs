...
const SidebarAdm = () => {
  ...
  const { cambiarSidebar } = AppContext;
  ...
  useEffect(() => {
    if (sidebarRef) {
      cambiarSidebar(sidebarRef.current);
      //   console.log(sidebarRef.current.children);
    }
  }, [sidebarRef]);
  ...
  return (
    <div
      className="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out"
      ref={sidebarRef}
    >
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          <button
            className="flex items-center px-4 py-2 mt-5 ml-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform 
                    bg-gray-600 rounded-md hover:bg-red-500 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-80"
            onClick={logOut}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
