...
import BarraGrupo from "../../components/charts/BarraGrupo";
  ...
  return (
      <LayoutAdm>
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-2">
          ...
          <div className="min-w-0 max-w-md p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <h4 className="mb-4 font-semibold text-gray-800 dark:text-gray-300">
              Doughnut/Pie
            </h4>
            <DonaChart />
