...
import Tema from "../../components/ui/BotonTema";
      ...
      <div className={`flex  items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900`}>
        <div className="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
          <div className="flex flex-col overflow-y-auto md:flex-row">
            ...
            <div className="relative flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                {mensaje && <Alerta />} 
              <div className="w-full">
                <form onSubmit={formik.handleSubmit} className="mt-20">
                  <h1 className="flex justify-between mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200">
                    Iniciar Sesión <Tema />
                  </h1>
                  <label className="block text-sm">
                    ...
                    <input
                      ...
                      className="block w-full mt-1 text-sm bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:shadow-outline-gray"
